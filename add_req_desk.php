...
<body>
    ...
    if (isset($_POST['save_data2'])) {
        ...
        $query = "INSERT INTO request(name, position, date, destination, purpose, timedept, typeofbusiness, time_returned,Status,status1,dest2,ImageName) VALUES ('$name', '$position', '$date', '$destination', '$purpose', '$timedept', '$typeofbusiness','00:00:00','Pending','Waiting For Pass Slip Approval','$destination','pending.png')";
        ...
        <div class="p-5 rounded shadow">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="add_req_desk.php" method="POST">
