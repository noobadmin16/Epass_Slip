...
} else if ($_SESSION['role'] == 'Employee' || $_SESSION['role'] == 'Desk Clerk') {
    header("location:login_v2.php");
}
?>
<!DOCTYPE html>
...
<style>
    @media screen and (max-width: 767px) {
        ...
        #label {
            font-size: 18px;
           text-align: center;
            margin-top: 10px; /* Add or adjust margin-top as needed */
    ...
    #texthead {
        ...
        #label {
            font-size: 30px;
           text-align: center; /* Add or adjust margin-top as needed */
